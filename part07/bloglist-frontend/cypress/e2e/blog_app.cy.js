describe("Blog app", function () {
  ...
  describe("When logged in", function () {
    ...
    it("A blog can be created", function () {
      ...
      cy.get(".addNotification").should(
        "contain",
        "a new blog new title by Elias Hietanen added!"
      );
    ...
    describe("When there are several blogs in the database", function () {
      ...
      it("The blog are ordered by the amount of likes they have", function () {
        ...
        cy.get(".detailedBlog")
          .eq(0)
          .should("contain", "first blog Elias Hietanen");
        cy.get(".detailedBlog").eq(0).should("contain", "likes 0");
        cy.get(".detailedBlog")
          .eq(1)
          .should("contain", "second blog Elias Hietanen");
